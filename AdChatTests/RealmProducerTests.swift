...
//
//        let messagesHistory: [Message] = (0..<4)
//            .map { index in
...
//
//        let newMessage = Message(author: users[0], content: "new message", timestamp: Date(), id: UUID().uuidString)
//
//        let conversation = Conversation(id: randomUsername())
//        conversation.persist()
//        conversation.add(users: users)
//        conversation.add(messages: [])
//
//        var count = 0
//
//        let disposable = conversation.managedObject().messages.signalProducer()
//            .toModelArray(Message.self)
//            .startWithValues { messages in
//                switch count {
//                case 0:
//                    expect(messages) == []
//                case 1:
//                    expect(messages) == messagesHistory
//                case 2:
//                    expect(messages) == messagesHistory.appending(newMessage)
//                    exp.fulfill()
//                default:
//                    fail()
//                }
...
//        }
//
//        conversation.add(messages: messagesHistory)
